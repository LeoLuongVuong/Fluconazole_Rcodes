...
#### Population level simulations dataset for optimised dosing 280623

```{r for optimised dosing 280623, warning=FALSE}

library(dplyr)
# Setwd for this chunk
setwd("D:/Projects/Fluconazole PoPPK KU Leuven/Fluconazol_project/Bootstrap and dosing simulation/BW_Simulations/Population_Simulations")

# Read in sdtab_pop.txt file
sdtab_pop_2706 <- read.table("sdtab_pop_2706.txt", header=TRUE, skip=1, sep="", na.strings="", strip.white=TRUE)

#change all the variables to numeric
sdtab_pop_2706[] <- lapply(sdtab_pop_2706, as.numeric)

#eliminate all NAs
sdtab_pop_2706 <- na.omit(sdtab_pop_2706)

# Extract only the trough events
sdtab_pop_2706_trough <- sdtab_pop_2706[sdtab_pop_2706$TROUGH == 1,]

# Create a new variable AUC24 for each ID
sdtab_pop_2706_trough <- sdtab_pop_2706_trough %>% group_by(ID) %>% mutate(AUC24 = AUC2 - lag(AUC2, default = AUC2[1]))%>%ungroup()
sdtab_pop_2706_trough<- sdtab_pop_2706_trough %>% mutate(AUC24 = ifelse(DAY == "1", AUC2,AUC24))

# Create a new variable fAUC, which equals AUC24*89 (we assume protein binding is 11%)
sdtab_pop_2706_trough$fAUC<- sdtab_pop_2706_trough$AUC24*0.89

#Eliminate peak column
sdtab_pop_2706_trough$PEAK<-NULL

# Extract ID, DV, fAUC, DAY columns
PTA_pop_2706 <- subset(sdtab_pop_2706_trough, select = c("ID", "DV", "fAUC", "DAY"))

# Calculate percentage of DV >= 7.5 per DAY (PTA_Cmin_75)
PTA_pop_2706$PTA_Cmin_75 <- 100 * ave(PTA_pop_2706$DV >= 7.5, PTA_pop_2706$DAY, FUN = mean)

# Calculate percentage of DV >= 80 per DAY (PTA_Cmin_80)
PTA_pop_2706$PTA_Cmin_80 <- 100 * ave(PTA_pop_2706$DV >= 80, PTA_pop_2706$DAY, FUN = mean)

# Calculate percentage of fAUC >= 200 per DAY (PTA_fAUC_200)
PTA_pop_2706$PTA_fAUC_200 <- 100 * ave(PTA_pop_2706$fAUC >= 200, PTA_pop_2706$DAY, FUN = mean)

# Create PTA_pop_2706_overall dataset with unique values of PTA_Cmin, PTA_fAUC, DAY
PTA_pop_2706_overall <- unique(PTA_pop_2706[c("PTA_Cmin_75","PTA_Cmin_80", "PTA_fAUC_200", "DAY")])

# Export trough and PTA dataset
setwd("D:/Projects/Fluconazole PoPPK KU Leuven/Fluconazol_project/Bootstrap and dosing simulation/BW_Simulations/Trough and PTA datasets")
write.csv(sdtab_pop_2706_trough, "sdtab_pop_2706_trough.csv",quote=F,row.names = FALSE)
write.csv(PTA_pop_2706_overall, "PTA_pop_2706_overall.csv",quote=F,row.names = FALSE)
...
# Read in sdtab_pop_std.txt file
...
#### Analyse population level simulations dataset for standard dosing 280623
...
# Read in sdtab_pop_std.txt file
sdtab_pop_std_2706 <- read.table("sdtab_pop_std_2706.txt", header=TRUE, skip=1, sep="", na.strings="", strip.white=TRUE)

#change all the variables to numeric
sdtab_pop_std_2706[] <- lapply(sdtab_pop_std_2706, as.numeric)

#eliminate all NAs
sdtab_pop_std_2706 <- na.omit(sdtab_pop_std_2706)

# Extract only the trough events
sdtab_pop_std_2706_trough <- sdtab_pop_std_2706[sdtab_pop_std_2706$TROUGH == 1,]

# Create a new variable AUC24 for each ID
sdtab_pop_std_2706_trough <- sdtab_pop_std_2706_trough %>% group_by(ID) %>% mutate(AUC24 = AUC2 - lag(AUC2, default = AUC2[1]))%>%ungroup()
sdtab_pop_std_2706_trough<- sdtab_pop_std_2706_trough %>% mutate(AUC24 = ifelse(DAY == "1", AUC2,AUC24))

# Create a new variable fAUC, which equals AUC24*89 (we assume protein binding is 11%)
sdtab_pop_std_2706_trough$fAUC<- sdtab_pop_std_2706_trough$AUC24*0.89

#Eliminate peak column
sdtab_pop_std_2706_trough$PEAK<-NULL

# Extract ID, DV, fAUC, DAY columns
PTA_pop_std_2706 <- subset(sdtab_pop_std_2706_trough, select = c("ID", "DV", "fAUC", "DAY"))

# Calculate percentage of DV >= 7.5 per DAY (PTA_Cmin_75)
PTA_pop_std_2706$PTA_Cmin_75 <- 100 * ave(PTA_pop_std_2706$DV >= 7.5, PTA_pop_std_2706$DAY, FUN = mean)

# Calculate percentage of DV >= 80 per DAY (PTA_Cmin_80)
PTA_pop_std_2706$PTA_Cmin_80 <- 100 * ave(PTA_pop_std_2706$DV >= 80, PTA_pop_std_2706$DAY, FUN = mean)

# Calculate percentage of fAUC >= 200 per DAY (PTA_fAUC_200)
PTA_pop_std_2706$PTA_fAUC_200 <- 100 * ave(PTA_pop_std_2706$fAUC >= 200, PTA_pop_std_2706$DAY, FUN = mean)

# Create PTA_pop_std_2706_overall dataset with unique values of PTA_Cmin, PTA_fAUC, DAY
PTA_pop_std_2706_overall <- unique(PTA_pop_std_2706[c("PTA_Cmin_75","PTA_Cmin_80", "PTA_fAUC_200", "DAY")])
# PTA of Cmin 80 mg/L is very low actually!

# Export trough and PTA dataset
setwd("D:/Projects/Fluconazole PoPPK KU Leuven/Fluconazol_project/Bootstrap and dosing simulation/BW_Simulations/Trough and PTA datasets")
write.csv(sdtab_pop_std_2706_trough, "sdtab_pop_std_2706_trough.csv",quote=F,row.names = FALSE)
write.csv(PTA_pop_std_2706_overall, "PTA_pop_std_2706_overall.csv",quote=F,row.names = FALSE)
...
#### Box plot AUC over DAY 280623

##### For optimised dosing 280623

```{r read those exported datasets again when R aborted, warning=FALSE}
setwd("D:/Projects/Fluconazole PoPPK KU Leuven/Fluconazol_project/Bootstrap and dosing simulation/BW_Simulations/Trough and PTA datasets")
sdtab_pop_2706_trough<-read.csv("sdtab_pop_2706_trough.csv")
library(dplyr)
pop_2706_trough <-sdtab_pop_2706_trough%>%select(ID, DAY, fAUC)
...
# Calculate the percentile
percentiles_opt <- pop_2706_trough %>%
group_by(DAY) %>%
summarize(p5 = quantile(fAUC, 0.05),
p25 = quantile(fAUC, 0.25),
p50 = median(fAUC),
...
# box plot
pop_auc_opt <- ggplot(pop_2706_trough, aes(x = factor(DAY), y = fAUC)) +
  geom_boxplot(fill = "steelblue", color = "#4E84C4", outlier.shape = NA, alpha = 0.6, coef = 0) +
  geom_segment(data = percentiles_opt, aes(x = factor(DAY), xend = factor(DAY), y = p5, yend = p25), color = "#4E84C4", size = 1) +
  geom_segment(data = percentiles_opt, aes(x = factor(DAY), xend = factor(DAY), y = p75, yend = p95), color = "#4E84C4", size = 1) +
  geom_hline(yintercept = 200, linetype = "dashed", color = "gray50", size = 0.8) +
...
# Save the plot
setwd("D:/Projects/Fluconazole PoPPK KU Leuven/Fluconazol_project/Bootstrap and dosing simulation/BW_Simulations/Manuscript_plots")
ggsave("pop_auc_opt_2706.png", pop_auc_opt, dpi = 300, width = 12, height = 7)

```

##### For standard dosing 280623

```{r read those exported datasets again when R aborted, warning=FALSE}
setwd("D:/Projects/Fluconazole PoPPK KU Leuven/Fluconazol_project/Bootstrap and dosing simulation/BW_Simulations/Trough and PTA datasets")
sdtab_pop_std_2706_trough<-read.csv("sdtab_pop_std_2706_trough.csv")
library(dplyr)
pop_std_2706_trough <-sdtab_pop_std_2706_trough%>%select(ID, DAY, fAUC)
...
# Calculate the percentile
percentiles_std <- pop_std_2706_trough %>%
group_by(DAY) %>%
summarize(p5 = quantile(fAUC, 0.05),
p25 = quantile(fAUC, 0.25),
p50 = median(fAUC),
...
# box plot
pop_auc_std <- ggplot(pop_std_2706_trough, aes(x = factor(DAY), y = fAUC)) +
  geom_boxplot(fill = "steelblue", color = "#4E84C4", outlier.shape = NA, alpha = 0.6, coef = 0) +
  geom_segment(data = percentiles_std, aes(x = factor(DAY), xend = factor(DAY), y = p5, yend = p25), color = "#4E84C4", size = 1) +
  geom_segment(data = percentiles_std, aes(x = factor(DAY), xend = factor(DAY), y = p75, yend = p95), color = "#4E84C4", size = 1) +
  geom_hline(yintercept = 200, linetype = "dashed", color = "gray50", size = 0.8) +
...
# Save the plot
setwd("D:/Projects/Fluconazole PoPPK KU Leuven/Fluconazol_project/Bootstrap and dosing simulation/BW_Simulations/Manuscript_plots")
ggsave("pop_auc_std_2706.png", pop_auc_std, dpi = 300, width = 12, height = 7)
...
#### Ribbon of optimised dosing 280623 - DV over TIME

```{r create a optimised dataset}

pop_2706 <- sdtab_pop_2706 %>% select(TIME,DV)

pop_2706 <- pop_2706[pop_2706$DV != 0 | pop_2706$TIME == 0, ]
        
data_summary_opt <- pop_2706 %>%
  group_by(TIME) %>%
  summarize(median= median(DV),
            min= quantile(DV, 0.05),
            max= quantile(DV, 0.95),
...
# save the plot
setwd("D:/Projects/Fluconazole PoPPK KU Leuven/Fluconazol_project/Bootstrap and dosing simulation/BW_Simulations/Manuscript_plots")
ggsave("DV_pop_opt_2706.png",pop_sim_opt, dpi = 300, width = 12, height = 7)
```
...
#### Ribbon of standard dosing 280623 - DV over TIME

```{r create a standard dataset}

pop_std_2706 <- sdtab_pop_std_2706 %>% select(TIME,DV)

pop_std_2706 <- pop_std_2706[pop_std_2706$DV != 0 | pop_std_2706$TIME == 0, ]

        
data_summary_std <- pop_std_2706 %>%
  group_by(TIME) %>%
  summarize(median= median(DV),
            min= quantile(DV, 0.05),
            max= quantile(DV, 0.95),
...
# save the plot
setwd("D:/Projects/Fluconazole PoPPK KU Leuven/Fluconazol_project/Bootstrap and dosing simulation/BW_Simulations/Manuscript_plots")
ggsave("DV_pop_std_2706.png",pop_sim_std, dpi = 300, width = 12, height = 7)
```
...
#### Combining box plots & DV plots of standard and optimised dosing 280623

```{r combining box plots & DV plots 280623}
library(grid)
library(gridExtra)

# Combine pop_sim_opt and pop_auc_opt horizontally
combined_opt <- grid.arrange(pop_sim_opt, pop_auc_opt, ncol = 2, top=textGrob("Optimised dosing regimen", gp = gpar(fontsize = 14, fontface = "bold")))
...
# Save the combined plots
setwd("D:/Projects/Fluconazole PoPPK KU Leuven/Fluconazol_project/Bootstrap and dosing simulation/BW_Simulations/Manuscript_plots")
ggsave("combined_auc&dv_plots_2706.png", combined_plots, dpi = 300, width = 8.27, height = 10.3, units = "in", limitsize = FALSE)
#ggsave("auc&dv_1406.png", combined_plots, dpi = 300, width = 22, height = 22, units = "cm", limitsize = FALSE)
...
# For standard dosing
analysis1_DAY1 <- sdtab_pop_std_2706_trough %>% filter(DAY == 1) %>% mutate(TA = ifelse(fAUC >= 200, 1, 0))
...
# For recommended dosing
analysis_DAY1 <- sdtab_pop_2706_trough %>% filter(DAY == 1) %>% mutate(TA = ifelse(fAUC >= 200, 1, 0))
...
# For recommended dosing - DAY 2
analysis_DAY2 <- sdtab_pop_2706_trough %>% filter(DAY == 2) %>% mutate(TA = ifelse(fAUC >= 200, 1, 0))
...
# For recommended dosing - DAY 7
analysis_DAY7 <- sdtab_pop_2706_trough %>% filter(DAY == 2) %>% mutate(TA = ifelse(fAUC >= 200, 1, 0))
...
# For recommended dosing - DAY 14
analysis_DAY14 <- sdtab_pop_2706_trough %>% filter(DAY == 2) %>% mutate(TA = ifelse(fAUC >= 200, 1, 0))
...
# Filter data for DAY 1 and calculate AUC
analysis1 <- sdtab_pop_std_2706_trough %>% filter(DAY == 1) %>% mutate(TA = ifelse(fAUC >= 200, 1, 0))
auc_results1 <- calculate_auc(analysis1)
...
# Repeat for DAY 2, 7, and 14
analysis2 <- sdtab_pop_std_2706_trough %>% filter(DAY == 2) %>% mutate(TA = ifelse(fAUC >= 200, 1, 0))
auc_results2 <- calculate_auc(analysis2)
plt_roc2 <- plot_roc(auc_results2$auc_obj, auc_results2$auc_label)
print(plt_roc2)

analysis7 <- sdtab_pop_std_2706_trough %>% filter(DAY == 7) %>% mutate(TA = ifelse(fAUC >= 200, 1, 0))
auc_results7 <- calculate_auc(analysis7)
plt_roc7 <- plot_roc(auc_results7$auc_obj, auc_results7$auc_label)
print(plt_roc7)

analysis14 <- sdtab_pop_std_2706_trough %>% filter(DAY == 14) %>% mutate(TA = ifelse(fAUC >= 200, 1, 0))
auc_results14 <- calculate_auc(analysis14)
plt_roc14 <- plot_roc(auc_results14$auc_obj, auc_results14$auc_label)
print(plt_roc14)
...
# 171023
FlucTotIV_clean_int <- FlucTotIV_clean%>%filter()

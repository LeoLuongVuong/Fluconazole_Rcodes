...
```{r reading new FlucTotIV_clean dataset}
...
impute_CREAT_DOS_INT_crrt <- FlucTotIV_clean_crrt[, c("TIME","RATE","AMT","DV","AGE","SEX","BW2","LENGTH", "CRRT","OCC","HOSPITAL","CREAT_DOS_INT","ID")]
...
### I add ID to the model in accordance with the thesis I cited below 280823
impute_CREAT_DOS_INT_nocrrt <- FlucTotIV_clean_nocrrt[, c("TIME","RATE","AMT","DV","AGE","SEX","BW2","LENGTH","OCC","HOSPITAL","CREAT_DOS_INT","ID")]
...
```{r for impute_CREAT_DOS_INT_crrt dataset 2l.pan method}
...
```{r for imputed_CREAT_DOS_INT_nocrrt dataset 2l.pan method}
...
```{r for impute_CREAT_DOS_INT_crrt dataset 2l.pmm method}
...
```{r for imputed_CREAT_DOS_INT_nocrrt dataset 2l.pmm method}

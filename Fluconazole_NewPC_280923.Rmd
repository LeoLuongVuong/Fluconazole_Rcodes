...
ROC_AUC_BW_DAY1 <- pROC::roc(TA_opt_day1$TA,
                        TA_opt_day1$BW,
                        auc.polygon = FALSE,
                        max.auc.polygon = FALSE,
                        grid = FALSE,
...
AUC_opt <- pROC::auc(ROC_AUC_BW_DAY1, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)

AUC_firstpart_opt <- round(as.numeric(sub(".*(: *)", "\\1", AUC_opt)), 3)

CI_AUC_opt <- pROC::ci.auc(ROC_AUC_BW_DAY1, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
...
AUC_std <- pROC::auc(ROC_AUC_BW1_DAY2, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
AUC_firstpart_std <- round(as.numeric(sub(".*(: *)", "\\1", AUC_std)), 3)
CI_AUC_std <- pROC::ci.auc(ROC_AUC_BW1_DAY2, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
AUC_anotherpart_std <- sub(".*(: *)", "\\1", CI_AUC_std)
AUC_secondpart_std <- as.numeric(substr(AUC_anotherpart_std[1], 1, 5))
AUC_thirdpart_std <- as.numeric(substr(AUC_anotherpart_std[3], 1, 5))
...
AUC_opt <- pROC::auc(ROC_AUC_BW_DAY2, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
AUC_firstpart_opt <- round(as.numeric(sub(".*(: *)", "\\1", AUC_opt)), 3)
CI_AUC_opt <- pROC::ci.auc(ROC_AUC_BW_DAY2, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
AUC_anotherpart_opt <- sub(".*(: *)", "\\1", CI_AUC_opt)
AUC_secondpart_opt <- as.numeric(substr(AUC_anotherpart_opt[1], 1, 5))
AUC_thirdpart_opt <- as.numeric(substr(AUC_anotherpart_opt[3], 1, 5))
...
AUC_std <- pROC::auc(ROC_AUC_BW1_DAY7, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
AUC_firstpart_std <- round(as.numeric(sub(".*(: *)", "\\1", AUC_std)), 3)
CI_AUC_std <- pROC::ci.auc(ROC_AUC_BW1_DAY7, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
AUC_anotherpart_std <- sub(".*(: *)", "\\1", CI_AUC_std)
AUC_secondpart_std <- as.numeric(substr(AUC_anotherpart_std[1], 1, 5))
AUC_thirdpart_std <- as.numeric(substr(AUC_anotherpart_std[3], 1, 5))
...
AUC_opt <- pROC::auc(ROC_AUC_BW_DAY7, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
AUC_firstpart_opt <- round(as.numeric(sub(".*(: *)", "\\1", AUC_opt)), 3)
CI_AUC_opt <- pROC::ci.auc(ROC_AUC_BW_DAY7, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
AUC_anotherpart_opt <- sub(".*(: *)", "\\1", CI_AUC_opt)
AUC_secondpart_opt <- as.numeric(substr(AUC_anotherpart_opt[1], 1, 5))
AUC_thirdpart_opt <- as.numeric(substr(AUC_anotherpart_opt[3], 1, 5))
...
AUC_std <- pROC::auc(ROC_AUC_BW1_DAY14, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
AUC_firstpart_std <- round(as.numeric(sub(".*(: *)", "\\1", AUC_std)), 3)
CI_AUC_std <- pROC::ci.auc(ROC_AUC_BW1_DAY14, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
AUC_anotherpart_std <- sub(".*(: *)", "\\1", CI_AUC_std)
AUC_secondpart_std <- as.numeric(substr(AUC_anotherpart_std[1], 1, 5))
AUC_thirdpart_std <- as.numeric(substr(AUC_anotherpart_std[3], 1, 5))
...
AUC_opt <- pROC::auc(ROC_AUC_BW_DAY14, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
AUC_firstpart_opt <- round(as.numeric(sub(".*(: *)", "\\1", AUC_opt)), 3)
CI_AUC_opt <- pROC::ci.auc(ROC_AUC_BW_DAY14, conf.level = 0.95, ci.alpha = 0.95, method = "bootstrap", boot.n = 1000, stratified = TRUE)
AUC_anotherpart_opt <- sub(".*(: *)", "\\1", CI_AUC_opt)
AUC_secondpart_opt <- as.numeric(substr(AUC_anotherpart_opt[1], 1, 5))
AUC_thirdpart_opt <- as.numeric(substr(AUC_anotherpart_opt[3], 1, 5))
...
# Convert roc objects to data frames
roc_std_DAY14 <- pROC::coords(ROC_AUC_BW1_DAY14)
roc_opt_DAY14 <- pROC::coords(ROC_AUC_BW_DAY14)
